...
function Terms() {
  return (
    <SiteLayout>
      <PageHeader eyebrow="Legal" title="Terms & Conditions" description="Last updated: July 2026" bgKey="terms" />
      <section className="py-20 bg-white">
        <article className="container-lux prose prose-neutral max-w-3xl">
          ...
          <Section title="Clinical services">
            Our therapist provides care within his scope of practice and current best evidence. Outcomes vary and are not guaranteed. Continue any prescribed medical care alongside physiotherapy.
          </Section>
          <Section title="Payments">
            Payment is due at the time of service unless otherwise arranged. We accept card, UPI, and cash.
          </Section>
